...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull NestedScrollView rootView,
      @NonNull Button btnManageCategories, @NonNull MaterialCardView cardMetrics,
      @NonNull ImageView imgAvatar, @NonNull LinearLayout layoutAdmin,
      @NonNull LinearLayout listProfileData, @NonNull ProgressBar progress,
      @NonNull TextView tvCoupons, @NonNull TextView tvEmail, @NonNull TextView tvEmailValue,
      @NonNull TextView tvFirstName, @NonNull TextView tvFirstNameValue,
      @NonNull TextView tvHeaderName, @NonNull TextView tvLastName,
      @NonNull TextView tvLastNameValue, @NonNull TextView tvPhone, @NonNull TextView tvPhoneValue,
      @NonNull TextView tvPoints, @NonNull TextView tvPurchases,
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((NestedScrollView) rootView, btnManageCategories,
          cardMetrics, imgAvatar, layoutAdmin, listProfileData, progress, tvCoupons, tvEmail,
          tvEmailValue, tvFirstName, tvFirstNameValue, tvHeaderName, tvLastName, tvLastNameValue,
          tvPhone, tvPhoneValue, tvPoints, tvPurchases, tvShippingAddress, tvShippingAddressValue);
    }
