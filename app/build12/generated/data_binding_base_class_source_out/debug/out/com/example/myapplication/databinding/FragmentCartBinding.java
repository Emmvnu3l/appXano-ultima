...
public final class FragmentCartBinding implements ViewBinding {
  ...
  private FragmentCartBinding(@NonNull FrameLayout rootView, @NonNull Button btnCheckout,
      @NonNull RecyclerView recycler, @NonNull ViewStateBinding state, @NonNull TextView tvEmpty,
  ...
  public static FragmentCartBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCartBinding((FrameLayout) rootView, btnCheckout, recycler, binding_state,
          tvEmpty, tvTotal);
    }
