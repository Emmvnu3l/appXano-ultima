...
public final class FragmentProductsBinding implements ViewBinding {
  ...
  private FragmentProductsBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView recycler,
  ...
  public static FragmentProductsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProductsBinding((FrameLayout) rootView, recycler, binding_state,
          swipeRefresh);
    }
