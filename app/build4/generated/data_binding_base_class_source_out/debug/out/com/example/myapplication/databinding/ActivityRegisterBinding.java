...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ScrollView rootView, @NonNull Button btnBack,
      ...
      @NonNull EditText etPhone, @NonNull EditText etShippingAddress,
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ScrollView) rootView, btnBack, btnRegister, etEmail,
          etFirstName, etLastName, etName, etPassword, etPhone, etShippingAddress, progress);
    }
