...
public final class ActivityProductDetailBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnCreateProduct;
  ...
  private ActivityProductDetailBinding(@NonNull ScrollView rootView,
      @NonNull Button btnCreateProduct, @NonNull TextInputEditText etSearch,
      @NonNull ImageView ivImage, @NonNull TextInputLayout tilSearch,
  ...
  public static ActivityProductDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button btnCreateProduct = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityProductDetailBinding((ScrollView) rootView, btnCreateProduct, etSearch,
          ivImage, tilSearch, tvDescription, tvName, tvPrice);
    }
