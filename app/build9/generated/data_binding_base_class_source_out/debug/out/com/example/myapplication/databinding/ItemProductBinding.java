...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull MaterialCardView rootView, @NonNull Button btnAddToCart,
      @NonNull ImageButton btnMinus, @NonNull ImageButton btnPlus, @NonNull ImageView ivImage,
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((MaterialCardView) rootView, btnAddToCart, btnMinus, btnPlus,
          ivImage, tvName, tvPrice, tvQuantity);
    }
